...
function(install_qt_library lib)
  if(${BR_INSTALL_DEPENDENCIES})
    ...
    elseif(CMAKE_HOST_APPLE)
      ...
      install(FILES ${Qt5_LIB_DIR}/libQt5${lib}.so.5.${Qt5Core_VERSION_MINOR}.${Qt5Core_VERSION_PATCH} DESTINATION lib)
      install(FILES ${Qt5_LIB_DIR}/libQt5${lib}.so.5.${Qt5Core_VERSION_MINOR} DESTINATION lib)
...
function(install_qt_audio)
  if(${BR_INSTALL_DEPENDENCIES})
    set(Qt5_PLUGIN_DIR "${Qt5_DIR}/../../qt5/plugins")
    set(AUDIO_DIR "${Qt5_PLUGIN_DIR}/audio")
    if(CMAKE_HOST_WIN32)
